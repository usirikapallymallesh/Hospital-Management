      ...
      <Layout>
        ...
        <Content style={{ marginTop: "64px", padding: "24px", overflowY: "auto" }}>
          <div className="p-4 bg-white rounded-lg shadow-md max-w-4xl mx-auto">
            <h2 className="text-3xl font-bold mb-6 text-center">Add New Patient</h2>
            <Form
              form={form}
              layout="vertical"
            ...
            >
              <Card className="mb-4">
                ...
                <Form.Item
                  name="age"
                  label="Age"
                  rules={[{ required: true, message: 'Please input the patient\'s age!' }]}
                >
                  <Input type="number" />
                </Form.Item>
                <Form.Item
              ...
              <div className="flex justify-center">
                <Button type="primary" htmlType="submit" className="mr-2">Add Patient</Button>
