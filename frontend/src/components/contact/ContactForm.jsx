    ...
    <div className="flex flex-col md:flex-row p-6 py-10 lg:py-16 bg-gray-100">
       ...
       <div className="md:w-1/2">
        ...
        <div className="mb-6 md:mr-4 md:ml-14">
          <h3 className="text-blue-500 font-semibold text-lg work-sans-color">GET IN TOUCH</h3>
          <h1 className="text-2xl font-bold text-gray-900 yeseva-one-regular">Contact</h1>
        </div>
      {/* Form Section */}
      ...
      <div className="md:w-1/2 grid grid-cols-1 sm:grid-cols-2 gap-6 md:mr-12">
        ...
        <div className=" rounded-sm shadow-lg p-2 flex flex-col justify-center  items-center bg-white hover:bg-blue-900  hover:text-white">
          <FaEnvelope className="text-6xl mb-4 text-blue-500" />
          <div>
            <h3 className="font-semibold text-2xl work-sans-color uppercase hover:text-white">Email</h3>
            <p className=" text-xl hover:text-white">contact@healthcare.com</p>
          </div>
        </div>
        ...
        <div className=" rounded-sm shadow-lg p-2 flex flex-col items-center justify-center bg-white hover:bg-blue-900 hover:text-white">
          <FaMapMarkerAlt className="text-blue-500 text-6xl mr-3 mb-4" />
          <div>
            <h3 className="font-semibold text-2xl work-sans-color uppercase">Location</h3>
            <p className="text-xl hover:text-white">123 Health St, Wellness City</p>
          </div>
        </div>
        ...
        <div className=" rounded-sm shadow-lg p-4 flex items-center flex-col justify-center bg-white hover:bg-blue-900 hover:text-white">
          <FaPhone className="text-blue-500 text-6xl mr-3 mb-4" />
          <div>
            <h3 className="font-semibold text-2xl work-sans-color uppercase">Contact Number</h3>
            <p className="text-xl hover:text-white">+1 (234) 567 8900</p>
          </div>
        </div>
        ...
        <div className="rounded-sm shadow-lg p-4 flex items-center justify-center hover:bg-blue-900 flex-col bg-white hover:text-white ">
          <FaClock className="text-blue-500 text-6xl mr-3 mb-4 " />
          <div>
            <h3 className="font-semibold text-2xl work-sans-color uppercase hover:text-white">Working Hours</h3>
            <p className="text-xl hover:text-white">Mon-Fri: 9 AM - 5 PM</p>
          </div>
        </div>
      </div>
    </div>
